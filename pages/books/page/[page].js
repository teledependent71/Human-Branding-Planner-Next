...
import booksPageInitialPaths3c126Resource from '../../../resources/books-page-initial-paths-3c126'
import booksPageInitialProps91d43Resource from '../../../resources/books-page-initial-props-91d43'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths3c126Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await booksPageInitialProps91d43Resource({
      ...context?.params,
